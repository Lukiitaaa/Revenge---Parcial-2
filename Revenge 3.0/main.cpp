...
int main()
{
   int opcion,juego, est;
   char salir;
   bool incorrecto = true;
   srand(time(NULL));
   int J1 = 6, J2 = 6, Compartidos = 2, Numero_Objetivo = 0, seleccionar, suma = 0, DadosResta = 0, PRUEBA = 8;
   int vDados1[J1], vDados2[J2], vDados12[2], stats[10] = {0}, a=0;
